...
const More = ({navigation}) => {
  const { COLORS,STYLES } = myTheme();
  const { setIsLoggedIn, setProfile, themeDark, setThemeDark } = useLogin();
    ...
    <View style={[styles.container, {backgroundColor: COLORS.surface}]}>
        ...
        <TouchableOpacity style={{flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', width: '100%', paddingHorizontal: 20, paddingVertical: 20}} onPress={() => {
          ...
          <View style={{flexDirection: 'row', alignItems: 'center', justifyContent: 'flex-start'}}>
            ...
            <Text style={[STYLES.textNormal, {paddingHorizontal: 10}]}>Help Desk</Text>
          </View>
          <AntDesign name='rightcircleo' size={25} color={COLORS.outline}/>
        </TouchableOpacity>
        <TouchableOpacity style={{flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', width: '100%', paddingHorizontal: 20, paddingVertical: 20}} onPress={() => {
          ...
          <View style={{flexDirection: 'row', alignItems: 'center', justifyContent: 'flex-start'}}>
            ...
            <Text style={[STYLES.textNormal, {paddingHorizontal: 10}]}>About Masca Mobile</Text>
          </View>
          <AntDesign name='rightcircleo' size={25} color={COLORS.outline}/>
        </TouchableOpacity>
        <Divider style={{width: '100%'}} />
